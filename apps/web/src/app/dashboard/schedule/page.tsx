        ...
        <div className="p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">View your timetable and find empty classrooms</p>
                </div>
    ...
    useEffect(() => {
        const fetchTimetable = async () => {
            try {
                ...
                const response = await fetch(`/api/classes/${encodeURIComponent(cleanClassName)}/location`);
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="space-y-1">
                                        <h4
                                            className={cn(
                                                "font-semibold",
                                                item.status === "now" ? "text-primary" : "text-foreground"
                                            )}
                                        >
                                            {item.title}
                                        </h4>
                                        <p
                                            className={cn(
                                                ...
                                                item.status === "now" ? "text-primary/80" : "text-muted-foreground"
                                            )}
                                        >
                                        ...
                                        <p className={cn(
                                            "text-sm flex items-center gap-1",
                                            item.status === "now" ? "text-primary/70" : "text-muted-foreground"
                                        )}>
                ...
                <form className="space-y-4" onSubmit={handleSearch}>
                    ...
                    <div className="space-y-2">
                        ...
                        <Select value={selectedDay} onValueChange={setSelectedDay}>
                            ...
                            <SelectContent>
                                {Object.entries(DAYS_ENGLISH).slice(0, 6).map(([fr, en]) => (
                    ...
                    <div className="space-y-4 pt-4 border-t border-border">
                        ...
                        <div>
                            ...
                            {roomData.empty.length === 0 ? (
                                ...
                                <ScrollArea className={cn("w-full", expanded ? "max-h-[250px]" : "")}>
                            ...
                            >
                                {expanded ? (
                                    ...
                                    <>
                                        ...
                                        Show All ({roomData.empty.length + roomData.warning.length} rooms)
                                    </>
                                )}
                            </Button>
                        )}
